...
namespace CMS.Web
{
    ...
    {
        public const string ApiName = "CMS.Web_api";
        public const string ApiFriendlyName = "CMS.Web API";
        public const string CMSWebClientID = "CMS.Web_spa";
